...
// Define pages array
var pages = [
{ name: "Home", url: "/blackjack/", accesskey: "h" },
{ name: "Documentation", url: "/blackjack/doc/", accesskey: "" },
{ name: "Download", url: "/blackjack/download/", accesskey: "g" }
];
...
if(m == 7 && dy == 31)
dt += "This is the game's "+currentage + " year"+(currentage===1?"":"s")+" Birthday. ";
